                ...
                while($row = $result->fetch()){
                    echo "<tr>";
                        ...
                        echo "<td class=\"text-right md:text-left\">";  //NOTICE use of anchors href="read.php?id='. $row['id'] .'"
                            echo '<a href="read.php?id='. $row['id'] .'" class="mr-6" title="View Record" data-toggle="tooltip"><span id="view-green" class="fa fa-eye text-neutral-900 hover:text-green-500"></span></a>';
                            echo '<a href="update.php?id='. $row['id'] .'" class="mr-6" title="Update Record" data-toggle="tooltip"><span id="update-blue" class="fa fa-pencil text-neutral-900 hover:text-blue-500"></span></a>';
                            echo '<a href="delete.php?id='. $row['id'] .'" title="Delete Record" data-toggle="tooltip"><span id="delete-red" class="fa fa-trash text-neutral-900 hover:text-red-600"></span></a>';
                        echo "</td>";
                    echo "</tr>";
                }
                echo "</tbody>";                            
